...
const TESTIMONIALS = [

  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Adaeze+Okafor&background=8B1A1A&color=FAF7F2&size=100&bold=true',
...

  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Funmilayo+Adeyemi&background=C9A96E&color=1A1A1A&size=100&bold=true',
...

  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Chiamaka+Eze&background=8B1A1A&color=FAF7F2&size=100&bold=true',
...

  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Toluwani+Badmus&background=C9A96E&color=1A1A1A&size=100&bold=true',
...

  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Ngozi+Mbachu&background=8B1A1A&color=FAF7F2&size=100&bold=true',
...

  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Sade+Lawson&background=C9A96E&color=1A1A1A&size=100&bold=true',
    location: 'Ibadan, Oyo',
